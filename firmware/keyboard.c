...
static const uint16_t map[5][16] = {
{
	...
	K(KEY_BACKSPACE, KEY_BACKSPACE), K(KEY_HOME, KEY_HOME)
},
{
	...
	K(KEY_BACKSLASH, KEY_BACKSLASH), K(KEY_DELETE, KEY_DELETE)
},
{
...
},
{
	...
	K(KEY_SLASH, KEY_SLASH), K(KEY_NONE, KEY_NONE), K(KEY_RIGHTSHIFT, KEY_RIGHTSHIFT),
	K(KEY_UP, KEY_UP), K(KEY_PAGEDOWN, KEY_PAGEDOWN)
},
{
